export const ActivityHorizontalItem = () => {
  return (
    <div className="relative h-28 bg-white p-2 bg-[url('assets/images/borrobudur.svg')] rounded-lg bg-cover bg-center">
      ...
      <p className="text-xs text-nowrap font-light text-white w-48 ">
        Candi Borrobudur
      </p>
...
ActivityHorizontalItem.displayName = "ActivityHorizontalItem";
